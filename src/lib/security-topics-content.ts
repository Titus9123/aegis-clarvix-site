...
export const securityTopics = {
  he: {
    ...
    intro:
      "לא רשימת מונחים טכניים — הסבר קצר על כל בעיה שאנחנו בודקים: מה הסיכון בפועל, ואיך מתקנים אותו. בלי לשלם לפני שאתם מבינים מה קניתם.",
    categories: [
      {
        name: "דואר, דומיין ותעודות אבטחה",
        items: [
          {
            title: "מה הסיכון בתת-דומיינים ישנים ששכחתם?",
            problem:
          ...
          {
            title: "איך מונעים זיוף מיילים בשם העסק שלכם?",
            problem:
          ...
          {
            title: "מה קורה כשתעודת האבטחה (TLS) חלשה או פגת תוקף?",
            problem:
          ...
          {
            title: "למה שירות ניהול חשוף לאינטרנט הוא סיכון?",
            problem:
      ...
      },
      {
        ...
        items: [
          {
            title: "מה זה CORS ומתי ההגדרה שלו מסוכנת?",
            problem:
          ...
          {
            title: "מה זה CSRF ואיך מגנים על טפסים באתר?",
            problem:
          ...
          {
            title: "אילו כותרות אבטחה חייבות להיות באתר שלכם?",
            problem:
          ...
          {
            title: "למה תוסף WordPress לא מעודכן מסכן את האתר?",
            problem:
          ...
          {
            title: "אילו קבצים אסור שיהיו נגישים בפומבי?",
            problem:
          ...
          {
            title: "למה נתיבי ניהול חשופים מסוכנים גם בלי פרצה?",
            problem:
          ...
          {
            title: "מה זה הזרקת SQL ואיך מונעים אותה?",
            problem:
          ...
          {
            title: "מה זה XSS ואיך הוא משמש לגניבת חשבונות?",
            problem:
          ...
          {
            title: "איך חולשות ידועות (CVE) מגיעות לאתר שלכם?",
            problem:
          ...
          {
            title: "מה זה SSRF, XXE ו-LFI בשפה פשוטה?",
            problem:
      ...
      },
      {
        ...
        items: [
          {
            title: "איך מפתחות API נחשפים באפליקציות שנבנו עם AI?",
            problem:
          ...
          {
            title: "מה זה Row Level Security ולמה חובה להפעיל אותו ב-Supabase?",
            problem:
          ...
          {
            title: "למה מפתח service_role לעולם לא צריך להגיע לדפדפן?",
            problem:
          ...
          {
            title: "איך יודעים אם כללי Firebase שלכם מתירניים מדי?",
            problem:
      ...
      },
      {
        ...
        items: [
          {
            title: "מה זה \"Denial of Wallet\" ואיך הוא מרוקן את התקציב שלכם?",
            problem:
          ...
          {
            title: "מה זה Prompt Injection ואיך הוא חושף את ההוראות של הבוט?",
            problem:
          ...
          {
            title: "למה הפלט של מודל AI חייב לעבור סינון לפני שמציגים אותו?",
            problem:
          ...
          {
            title: "מה הסיכון בסוכן AI עם יותר מדי הרשאות?",
            problem:
    ...
    categories: [
      {
        ...
        items: [
          {
            title: "What's the risk in old subdomains you forgot about?",
            problem:
          ...
          {
            title: "How do you stop someone spoofing email from your domain?",
            problem:
          ...
          {
            title: "What happens when your TLS certificate is weak or expired?",
            problem:
          ...
          {
            title: "Why is an exposed admin service a serious risk?",
            problem:
      ...
      },
      {
        ...
        items: [
          {
            title: "What is CORS, and when does its configuration become dangerous?",
            problem:
          ...
          {
            title: "What is CSRF, and how do you protect your forms?",
            problem:
          ...
          {
            title: "Which security headers does your site actually need?",
            problem:
          ...
          {
            title: "Why does an outdated WordPress plugin put your site at risk?",
            problem:
          ...
          {
            title: "Which files should never be publicly accessible?",
            problem:
          ...
          {
            title: "Why are exposed admin paths risky even without a flaw?",
            problem:
          ...
          {
            title: "What is XSS, and how is it used to hijack accounts?",
            problem:
          ...
          {
            title: "How do known vulnerabilities (CVEs) end up on your site?",
            problem:
          ...
          {
            title: "What are SSRF, XXE and LFI in plain language?",
            problem:
      ...
      },
      {
        ...
        items: [
          {
            title: "How do API keys get exposed in AI-built apps?",
            problem:
          ...
          {
            title: "What is Row Level Security, and why is it mandatory in Supabase?",
            problem:
          ...
          {
            title: "Why should a service_role key never reach the browser?",
            problem:
          ...
          {
            title: "How do you know if your Firebase rules are too permissive?",
            problem:
      ...
      },
      {
        ...
        items: [
          {
            title: "What is \"denial of wallet\", and how does it drain your budget?",
            problem:
          ...
          {
            title: "What is prompt injection, and how does it leak your bot's instructions?",
            problem:
          ...
          {
            title: "Why must AI model output be sanitized before it's displayed?",
            problem:
          ...
          {
            title: "What's the risk of an AI agent with too many permissions?",
            problem:
