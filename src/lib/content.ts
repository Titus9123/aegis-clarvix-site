...
export const content = {
  he: {
    ...
    services: {
      ...
      title: "שני מקומות טובים להתחיל בהם",
      items: [
        {
        ...
        {
          title: "בדיקת מוכנות לרגולציה",
          desc: "בודקים את המוכנות שלכם מול תיקון 13 לחוק הגנת הפרטיות, ומראים בדיוק מה חסר.",
          bullets: [
            "שאלון בקרות ניהוליות",
            "השוואה מול תיקון 13",
            "דוח פערים לפי סדר עדיפויות",
            "לא מהווה תעודת הסמכה רשמית",
          ],
          price: "₪2,000–₪4,000",
          priceNote: "חד פעמי",
        },
  ...
  en: {
    ...
    services: {
      ...
      title: "Two good places to start",
      items: [
        {
        ...
        },
        {
          ...
          desc: "We check your readiness against Amendment 13 of Israel's Privacy Law, and show exactly what's missing.",
          bullets: [
            "Administrative controls questionnaire",
            "Gap analysis against Amendment 13",
